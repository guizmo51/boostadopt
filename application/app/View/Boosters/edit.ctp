...
<?php echo $this->Form->create('Booster'); ?>
	<fieldset>
		<legend><?php echo __('Edit Booster'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Booster.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Booster.id'))); ?></li>
