...
<?php echo $this->Form->create('Rechargement'); ?>
	<fieldset>
		<legend><?php echo __('Edit Rechargement'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Rechargement.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Rechargement.id'))); ?></li>
